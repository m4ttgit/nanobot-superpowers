...
```
/nanobot-adversarial-review              # Review staged/unstaged changes
/nanobot-adversarial-review --diff HEAD~3  # Review last 3 commits
/nanobot-adversarial-review --file src/auth.ts  # Review a specific file
```
...
```
/nanobot-adversarial-review --diff main...HEAD
```
...
3. Note any **project conventions** from NANOBOT.md, .editorconfig, linting configs, or existing patterns.
...
- **When Nanobot said "looks good"** — if you got an easy approval, run this for a second opinion
...
- Related: `nanobot-senior-security` — deep security analysis
- Related: `nanobot-code-reviewer` — general code quality review
- Complementary: `nanobot-iso27001-info-sec` — quality management workflows
