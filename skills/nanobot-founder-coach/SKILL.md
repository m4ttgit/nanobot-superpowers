...
Personal leadership development for founders and first-time CEOs. Covers founder archetype identification, delegation frameworks, energy management, CEO calendar audits, leadership style evolution, blind spot identification, imposter syndrome, founder mental health, and succession planning. Not for day-to-day management — for the founder's personal scaling that determines company ceiling.
...
Use the questions in this file to identify: Builder / Seller / Operator / Visionary.

### Delegation Audit#
```
Rate each major function:
1. Do exactly what I tell you → not delegation (instruction)
2. Research this and report back → information gathering (low delegation)
3. Propose a solution and I'll decide → thinking delegation (medium)
4. Decide and tell me what you decided → decision delegation (high)
5. Handle it completely — update me if it's outside these parameters → full delegation
```

Most founders are stuck at level 2–3. That's the bottleneck.
...
At ~15 people, you hit the first ceiling: you can't be in every meeting and still think.  
At ~50 people, the second: your style starts creating culture problems.  
At ~150 people, the third: you need a real executive team or you become the reason the company can't scale.
...
| 200+ | Board, investors, and external. You're a symbol. |
...
- **Context hoarding:** Knowing what's happening without sharing it, then being frustrated they make bad decisions
...
It won't go away. It evolves. The founder who was scared to pitch to investors is now scared to manage a board. The founder who was scared to hire is now scared to fire.
...
- **Normalize the feeling:** "I feel underprepared for this investor meeting" → tell a trusted person, removes 50% of its power
- **Do the thing anyway.** Competence comes from doing, not from feeling ready.
- **Name it:** Saying "I'm feeling imposter syndrome about this board meeting" to a trusted person removes 50% of its power.
...
- Founder calendar < 10% strategy → you're running, not leading
- No 360 feedback in 12+ months → blind spots growing
- Energy audit showing > 30% red → burnout incoming, intervene now

## Output Artifacts#

| Request | You Produce |
|---------|-------------|
| "What's my leadership archetype?" | Archetype identification with blind spots, complementary hire recommendation |
| "Delegation audit" | Current delegation level per function, ladder advancement plan |
| "Energy audit" | Week-long energy map, red-flag identification, recovery plan |
| "CEO calendar review" | 4-week audit with category %, red flags, rebalancing plan |
| "Founder development plan" | Personal OKRs, coaching needs, leadership transition timeline |

## Reasoning Technique: First Principles#

Decompose to fundamental personal needs: autonomy, mastery, purpose, growth. Question any leadership practice that can't tie back to these. Rebuild your leadership from evidence, not inherited style.
