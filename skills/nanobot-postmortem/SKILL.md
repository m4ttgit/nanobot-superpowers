# /nanobot-postmortem — Honest Analysis of What Went Wrong

**Command:** `/nanobot-postmortem <event>`
...
- Why? Because that's just how enterprise sales works.
...
**Root cause:** The fundamental condition that made the outcome probable. Fix this, and this class of problem won't recur.
