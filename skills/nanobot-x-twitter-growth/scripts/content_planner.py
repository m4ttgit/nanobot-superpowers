...
CONTENT_FORMATS = {
    "atomic_tweet": {"growth_weight": 0.3, "description": "Single tweet — observation, tip, or hot take"},
    "thread": {"growth_weight": 0.35, "description": "5-12 tweet deep dive — highest reach potential"},
    "question": {"growth_weight": 0.15, "description": "Engagement bait — drives replies"},
    "quote_tweet": {"growth_weight": 0.10, "description": "Add value to someone else's content"},
    "reply_session": {"growth_weight": 0.10, "description": "30 min focused engagement on target accounts"},
}
