...
**Core principle:** Write comprehensive plans assuming the engineer has zero context. Document everything they need to know: which files to touch, what code to write, how to test it. Give them bite-sized tasks.
