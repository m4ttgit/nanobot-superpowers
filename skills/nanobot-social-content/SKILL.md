...
- **content-strategy**: USE when the chosen channel is content/SEO and a full topic plan is needed. NOT for single-day launch execution.#
- **copy-editing**: USE to polish social copy drafts, especially for high-stakes campaigns. NOT for idea generation.#
