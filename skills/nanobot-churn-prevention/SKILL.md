...
- See references for full decision trees and templates.
...
### Email Sequence (high level)

- Day 0: Payment failed
- Day 3: Retry coming up
- Day 7: We tried again — still failing
- Day 12: Final notice
- Day 16: Account cancelled

See references/dunning-guide.md for full sequences and configuration.
