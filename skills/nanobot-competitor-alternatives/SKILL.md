...
|--------|-----------------|
| Format 1 | "[Competitor] alternative", "alternative to [Competitor]", "switch from [Competitor]" |
| Format 2 | "[Competitor] alternatives", "best [Competitor] alternatives", "tools like [Competitor]" |
| Format 3 | "[You] vs [Competitor]", "[Competitor] vs [You]" |
| Format 4 | "[Competitor A] vs [Competitor B]" |
...
- **content-strategy** — USE when planning a full competitive content program across multiple pages; NOT for tactical page writing.
